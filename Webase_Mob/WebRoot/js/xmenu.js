...
WebFXMenuItem.prototype.toString = function () {
	return	"<a" +
			...
			">" +
			(this.subMenu ? "<img class='arrow' src=\"" + webfxMenuImagePath + "./images/frame/arrow.right.png\">" : "") +
			this.text +
			"</a>";
};
...
WebFXMenuButton.prototype.toString = function () {
	return	"&nbsp;&nbsp;"+"<img src='./images/frame/item.gif' align='absmiddle'>"
	        + "&nbsp;" + "<a" +
			" id='" + this.id + "'" +
			" href=\"" + this.href + "\"" +
			(this.target ? " target=\"" + this.target + "\"" : "") +
			...
			">" +
			this.text +
			(this.subMenu ? " <img class='arrow' src=\"" + webfxMenuImagePath + "./images/frame/arrow.down.png\" align='absmiddle'>" : "") +
			"</a>";
};
