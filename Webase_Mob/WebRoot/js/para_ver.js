...
function cal_popup1 (str_datetime) {
	...
	var obj_calwindow = window.open(
		'./js/paraVer.html?datetime=' + this.dt_current.valueOf()+ '&id=' + this.id,
		'Calendar', 'width=250,height='+(this.time_comp ? 225 : 190)+
...
function cal_prs_date1 (str_date) {
    //alert(str_date);
        ...
        str_date = cal_gen_date1(cur_date);
        //modify over
